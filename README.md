...
# 💫 About Me:
Passionate about problem-solving and technology | Currently focusing on web and .NET development | 🇧🇷 Brazilian from Belo Horizonte, Minas Gerais | 💻 Computer Science student. | VueJS | C# | MongoDB | ASP.NET | .NET Core | JavaScript | Node.js
